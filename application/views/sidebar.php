      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="<?php echo base_url('dashbord'); ?>" class="nav-link active">
          ...
          <li class="nav-item">
                <a href="<?php echo base_url('list_erp_users'); ?>" class="nav-link">
                <i class="nav-icon far fa-plus-square"></i>
                  <p>ERP Users</p>
                </a>
              </li>
          ...
          <li class="nav-item">
                <a href="<?php echo base_url('list_parts'); ?>" class="nav-link">
                <i class="nav-icon far fa-plus-square"></i>
                  <p>Parts</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url('list_standard_library'); ?>" class="nav-link">
                <i class="nav-icon far fa-plus-square"></i>
                  <p>Standard Library</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url('list_drawing_revision'); ?>" class="nav-link">
                <i class="nav-icon far fa-plus-square"></i>
                  <p>Drawing history</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url('list_slide_show'); ?>" class="nav-link">
                <i class="nav-icon far fa-plus-square"></i>
                  <p>Slide Show</p>
                </a>
              </li>
